...
for root, folders, services in ags.walk():
    print('{0})'.format(root))
    print('{0})'.format(folders))
    print('{0})'.format(services))
    print('\n')

# access "ahps_gauges" service (stream gauges)
gauges = ags.get_MapService('ahps_gauges')
print('{0}'.format(gauges.url)) #print MapService url

# print layer names
print('{0}'.format(gauges.list_layers()))
...
print('{0}'.format(lyr.list_fields()))
...
for candidate in candidates:
    print('{0}'.format(candidate.location))
...
for attachment in attachments:
    print('{0}'.format(attachment))
    print('{0}, {1}'.format(attachment.contentType, attachment.size))
