...
if __name__ == '__main__':
    ...
    import _ags
    reload(_ags)
    url = 'http://arcserver2.bolton-menk.com:6080'
    url1 = _ags.BMI_ADMIN
    url2 = _ags.BMI_INT_ADMIN

    usr, pw = _ags.creds()
    ags1 = ArcServerAdmin(url1, usr, pw)
    ags1.startServices(folderName='BELL')
##    ags2 = ArcServerAdmin(url2, usr, pw)
##    ds = ags1.dataStore
##    ds2 = ags2.dataStore
##    folder = ags.folder('TEST')
##    test = folder.addPermission(private=False)
##    ds = ags.dataStore
##    ags.startServices(folderName='TEST')

##    url = 'http://arcserver2.bolton-menk.com:6080/arcgis/admin/services/TEST/Colorado_Webmap_REST.MapServer'
##
##    it = {
##          "culture": "en-US",
##          "name": "Colorado_Webmap_REST",
##          "guid": "C8589626-857F-42EE-820F-3747C30AEAB7",
##          "catalogPath": "",
##          "snippet": "",
##          "description": "colorado vacation",
##          "summary": "",
##          "title": "Colorado_Webmap_REST",
##          "tags": [],
##          "type": "Map Service",
##          "typeKeywords": [
##            "Data",
...
##        }
##
##    colo = Service(url, usr, pw)
##    image = r'C:\Users\calebma\Desktop\Colorado\IMG_0963.JPG'
####    colo.editItemInfo(it, image)
##    stats = colo.statistics()



##    bell_url = 'http://arcserver2.bolton-menk.com:6080/arcgis/admin/services/BELL/Bell_Webmap_REST.MapServer'
##    bell = Service(bell_url, usr, pw)
##    print bell.configuredState
##    bell.stop()
##    bell.start()
